...
// Adaugare: delegare catre Formular detalii camera
    private void adaugaCamera() {
        this.getUI().ifPresent(ui -> ui.navigate(String.valueOf(org.example.FormCamereView.class)));
    }
    ...
    private void editCamera() {
        ...
        if (this.camera != null) {
            this.getUI().ifPresent(ui -> ui.navigate(org.example.FormCamereView.class, this.camera.getNumarCamera()));
        }
    }
    // CRUD actions
